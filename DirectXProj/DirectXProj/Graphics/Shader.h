...
public:
    ...
    bool LoadWithLayout(ID3D11Device* device, const std::wstring& vsPath, const std::wstring& psPath, const D3D11_INPUT_ELEMENT_DESC* layoutDesc, UINT numElements, bool cacheCompiled = false);
    bool Reload();
...
private:
    ...
    std::vector<D3D11_INPUT_ELEMENT_DESC> m_customLayout;
};
